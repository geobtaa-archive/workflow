...
csvfile = open('sprint.csv', 'r') #opens the csv with the GBL data. Change this as needed
...
for row in reader: #each row is a dictionary
    code = ""
    ref = []
    small_dict = {"geoblacklight_version":"1.0","layer_modified_dt":date_modified,"dc_rights_s":"Public"} #starting dictionary with set values
